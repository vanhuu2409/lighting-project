        ...
        >
          {demoExperiences.map((item, index) => (
            <motion.div
              key={index}
              variants={fadeInUp}
              className='group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 ease-out cursor-pointer overflow-hidden transform relative'
            >
              <Link href={item.href} target='_blank' className='block'>
                  ...
                  <div className='relative aspect-[3/2] overflow-hidden'>
                    <Image
                      ...
                      className={`object-cover group-hover:scale-110 transition-transform duration-500 ${
                        item.isComingSoon ? "brightness-50 blur-sm" : ""
                      }`}
                      placeholder='blur'
                ...
                <div className='p-6'>
                  ...
                  <div className='flex items-end justify-between'>
                    <div>
                      <p className='text-sm text-gray-500 mb-1'>Chỉ từ</p>
              ...
              {item.isComingSoon && (
                <div className='absolute inset-0 bg-white/20 backdrop-blur-md flex items-center justify-center rounded-2xl z-10'>
